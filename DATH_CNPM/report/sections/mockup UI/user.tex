\subsection{User view}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Home.png}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/My Plan.png}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Search.png}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Favorite.png}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Profile - user.png}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Dish detail - about.png}}
        \captionof{figure}{Trang chi tiết món ăn (About)}
    \end{minipage}
    \hspace{0.05\textwidth}
    \begin{minipage}{0.45\textwidth}
        \begin{tblr}{
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Dish detail - review.png}}
        \captionof{figure}{Trang chi tiết món ăn (Review)}
    \end{minipage}
    \hspace{0.05\textwidth}
    \begin{minipage}{0.45\textwidth}
        \begin{tblr}{
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Create plan.png}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Calculate TDEE.png}}
