\subsection{General View}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Login.png}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Sign up.png}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Forgot password step1.png}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Forgot password step2.png}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Forgot password final.png}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Change password-1.png}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Change password-2.png}}
