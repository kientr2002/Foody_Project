\subsection{Admin view}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Manage account.png}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Manage dish.png}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Manage dish - submenu.png}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Dish detail - manage -1.png}}
        \captionof{figure}{Trang thông tin món ăn (About)}
    \end{minipage}
    \hspace{0.05\textwidth}
    \begin{minipage}{0.45\textwidth}
        \begin{tblr}{
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Dish detail - manage - 2.png}}
        \captionof{figure}{Trang thông tin món ăn (Review)}
    \end{minipage}
    \hspace{0.05\textwidth}
    \begin{minipage}{0.45\textwidth}
        \begin{tblr}{
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Account detail - manage.png}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Profile - admin.png}}
    ...
    \begin{minipage}{0.5\textwidth}
    	\vspace{1cm}
    	\fbox{\includegraphics[width=0.7\textwidth]{images/ui/Edit dish.png}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Warning.png}}
